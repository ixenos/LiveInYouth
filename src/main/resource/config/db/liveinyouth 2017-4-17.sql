...
-- Records of comment
-- ----------------------------
INSERT INTO `comment` VALUES ('1', '1', '放空', '12', 'Yuban', '0', '只要她还肯露面，只要她还肯唱歌，只要她开心，她怎样都行。', '3724');
INSERT INTO `comment` VALUES ('2', '1', '放空', '13', 'Dada', '0', '放空 感同身受 有时候觉得融不进大家 觉得好难受 会一瞬间抽离 这是什么病？ 快乐到一半刹住 觉得空洞洞的', '2180');
...
CREATE TABLE `song_list` (
  ...
  `LIST_NAME` varchar(50) NOT NULL DEFAULT 'default' COMMENT '歌单名,所谓歌单取出关键字，为收藏歌单时使用“default”',
...
-- ----------------------------
INSERT INTO `song_list` VALUES ('1', '2', 'ixenos', 'default', '0', '3634', '1,2,3,5,6', '/LiveInYouth/images/discoverSongList/songList/songList-1.jpg', '小梦大半');
INSERT INTO `song_list` VALUES ('2', '2', 'ixenos', '尔雅', '1', '9238', '2', '/LiveInYouth/images/discoverSongList/songList/songList-2.jpg', '温文尔雅');
INSERT INTO `song_list` VALUES ('3', '2', 'ixenos', '花白', '1', '7346', '2,3', '/LiveInYouth/images/discoverSongList/songList/songList-3.jpg', '纯白无暇');
INSERT INTO `song_list` VALUES ('4', '2', 'ixenos', '暌隔', '1', '6873', '2,3,5', '/LiveInYouth/images/discoverSongList/songList/songList-4.jpg', '闲梦远');
INSERT INTO `song_list` VALUES ('5', '2', 'ixenos', '境', '1', '9325', '5', '/LiveInYouth/images/discoverSongList/songList/songList-5.jpg', '如也');
INSERT INTO `song_list` VALUES ('6', '2', 'ixenos', '天尽头', '1', '3252', '2,3,6', '/LiveInYouth/images/discoverSongList/songList/songList-6.jpg', '何处有相求');
INSERT INTO `song_list` VALUES ('7', '2', 'ixenos', '感觉体验馆', '1', '9573', '2,3,5,6', '/LiveInYouth/images/discoverSongList/songList/songList-1.jpg', '眼聆');
INSERT INTO `song_list` VALUES ('8', '2', 'ixenos', '没有人', '1', '8634', '6', '/LiveInYouth/images/discoverSongList/songList/songList-8.jpg', '在等着没有人');
INSERT INTO `song_list` VALUES ('9', '2', 'ixenos', '玉陨', '1', '7576', '2,6', '/LiveInYouth/images/discoverSongList/songList/songList-9.jpg', '香消');
...
CREATE TABLE `user` (
  ...
  PRIMARY KEY (`USER_ID`)
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=utf8 COMMENT='用户表USER';

-- ----------------------------
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES ('1', 'admin', '12345', 'admin@qq.com', '1', '0');
INSERT INTO `user` VALUES ('2', 'ixenos', '10613', 'ixenos@foxmail.com', '1', '0');
INSERT INTO `user` VALUES ('3', 'Alexs', '12345', 'alex@qq.com', '0', '0');
INSERT INTO `user` VALUES ('4', 'Angelababy', '12345', 'babyface@qq.com', '0', '0');
INSERT INTO `user` VALUES ('5', 'YogaLin', '12345', 'yogalin@official.com', '0', '0');
INSERT INTO `user` VALUES ('6', 'cesei', '12345', 'ixenos@qq.om', '0', '0');
INSERT INTO `user` VALUES ('9', 'q123123q', '12345', '1q23@123.123', '0', '0');
INSERT INTO `user` VALUES ('10', 'Yanlin', '12345', 'yanlin@foxmail.com', '0', '0');
INSERT INTO `user` VALUES ('11', 'lierya', '12345', 'yyiy11yazi@163.com', '0', '0');
INSERT INTO `user` VALUES ('12', 'Yuban', '12345', 'yuban@qq.com', '0', '0');
INSERT INTO `user` VALUES ('13', 'Dada', '12345', 'dada@qq.com', '0', '0');
INSERT INTO `user` VALUES ('14', 'Allen', '12345', 'allen@qq.com', '0', '0');
