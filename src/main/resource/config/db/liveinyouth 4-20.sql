...
-- Records of song
-- ----------------------------
INSERT INTO `song` VALUES ('1', '放空', null, '1', '范晓萱', '2', '谢谢', 'http://localhost:8081/LiveInYouth/video/mp4/范晓萱 - 放空.mp4', '1', '1', '1', '123', '99999', '7777', '6666');
INSERT INTO `song` VALUES ('2', '落花流水', '1,2,3,4,6,9', '2', '陈奕迅', '4', 'Solidays', 'http://localhost:8081/LiveInYouth/audio/mp3/陈奕迅 - 落花流水.mp3', '1', '0', '0', '234', '2222', '3333', '4444');
INSERT INTO `song` VALUES ('3', '拥有', '1,3,4,6,7', '4', '林宥嘉', '1', '美妙生活', 'http://localhost:8081/LiveInYouth/audio/mp3/林宥嘉 - 拥有.mp3', '1', '0', '0', '345', '2323', '3434', '4545');
INSERT INTO `song` VALUES ('5', '虚拟', '1,2,4,5,7', '6', '陈粒', '3', '小梦大半', 'http://localhost:8081/LiveInYouth/audio/mp3/陈粒 - 虚拟.mp3', '1', '0', '0', '567', '93734', '2857', '8384');
INSERT INTO `song` VALUES ('6', '放空', '1,2,6,7,8,9', '1', '范晓萱', '2', '谢谢', 'http://localhost:8081/LiveInYouth/audio/mp3/范晓萱 - 放空.mp3', '1', '0', '0', '6565', '6767', '5656', '7676');
...
-- ----------------------------
INSERT INTO `song_list` VALUES ('1', '聆', '2,3,5,6', '3', 'Alexs', '0', '3634', '/LiveInYouth/images/discoverSongList/songList/songList-1.jpg', '小梦大半');
INSERT INTO `song_list` VALUES ('2', '尔雅', '2,5,6', '2', 'ixenos', '1', '9238', '/LiveInYouth/images/discoverSongList/songList/songList-2.jpg', '温文尔雅');
INSERT INTO `song_list` VALUES ('3', '花白', '2,3', '4', 'Angelababy', '1', '7346', '/LiveInYouth/images/discoverSongList/songList/songList-3.jpg', '纯白无暇');
INSERT INTO `song_list` VALUES ('4', '暌隔', '2,3,5', '5', 'YogaLin', '1', '6873', '/LiveInYouth/images/discoverSongList/songList/songList-4.jpg', '闲梦远');
INSERT INTO `song_list` VALUES ('5', '境', '5', '6', 'cesei', '1', '9325', '/LiveInYouth/images/discoverSongList/songList/songList-5.jpg', '如也');
INSERT INTO `song_list` VALUES ('6', '天尽头', '2,3,6', '9', 'q123123q', '1', '3252', '/LiveInYouth/images/discoverSongList/songList/songList-6.jpg', '何处有相求');
INSERT INTO `song_list` VALUES ('7', '感觉体验馆', '3,5,6', '10', 'Yanlin', '1', '9573', '/LiveInYouth/images/discoverSongList/songList/songList-1.jpg', '眼聆');
INSERT INTO `song_list` VALUES ('8', '没有人', '6', '11', 'lierya', '1', '8634', '/LiveInYouth/images/discoverSongList/songList/songList-8.jpg', '在等着没有人');
INSERT INTO `song_list` VALUES ('9', '玉陨', '2,6', '12', 'Yuban', '1', '7576', '/LiveInYouth/images/discoverSongList/songList/songList-9.jpg', '香消');
...
CREATE TABLE `song_list_map` (
  ...
  `LIST_NAME` varchar(255) NOT NULL COMMENT '歌单名',
  `SONG_ID` int(11) unsigned NOT NULL COMMENT '歌曲表ID',
  `SONG_NAME` varchar(255) NOT NULL COMMENT '歌曲名',
  PRIMARY KEY (`SONG_LIST_MAP_ID`)
) ENGINE=InnoDB AUTO_INCREMENT=23 DEFAULT CHARSET=utf8 COMMENT='歌曲与歌单的映射表';

-- ----------------------------
-- Records of song_list_map
-- ----------------------------
INSERT INTO `song_list_map` VALUES ('1', '1', '聆', '2', '落花流水');
INSERT INTO `song_list_map` VALUES ('2', '2', '尔雅', '2', '落花流水');
INSERT INTO `song_list_map` VALUES ('3', '3', '花白', '2', '落花流水');
INSERT INTO `song_list_map` VALUES ('4', '4', '暌隔', '2', '落花流水');
INSERT INTO `song_list_map` VALUES ('5', '6', '天尽头', '2', '落花流水');
INSERT INTO `song_list_map` VALUES ('6', '9', '玉陨', '2', '落花流水');
INSERT INTO `song_list_map` VALUES ('7', '1', '聆', '3', '拥有');
INSERT INTO `song_list_map` VALUES ('8', '3', '花白', '3', '拥有');
INSERT INTO `song_list_map` VALUES ('9', '4', '睽隔', '3', '拥有');
INSERT INTO `song_list_map` VALUES ('10', '6', '天尽头', '3', '拥有');
INSERT INTO `song_list_map` VALUES ('11', '7', '感觉体验馆', '3', '拥有');
INSERT INTO `song_list_map` VALUES ('12', '1', '聆', '5', '虚拟');
INSERT INTO `song_list_map` VALUES ('13', '4', '睽隔', '5', '虚拟');
INSERT INTO `song_list_map` VALUES ('14', '5', '境', '5', '虚拟');
INSERT INTO `song_list_map` VALUES ('15', '7', '感觉体验馆', '5', '虚拟');
INSERT INTO `song_list_map` VALUES ('16', '1', '聆', '6', '放空');
INSERT INTO `song_list_map` VALUES ('17', '6', '天尽头', '6', '放空');
INSERT INTO `song_list_map` VALUES ('18', '7', '感觉体验馆', '6', '放空');
INSERT INTO `song_list_map` VALUES ('19', '8', '没有人', '6', '放空');
INSERT INTO `song_list_map` VALUES ('20', '9', '玉殒', '6', '放空');
INSERT INTO `song_list_map` VALUES ('21', '2', '尔雅', '5', '虚拟');
INSERT INTO `song_list_map` VALUES ('22', '2', '尔雅', '6', '放空');
...
INSERT INTO `user` VALUES ('2', 'ixenos', '10613', 'ixenos@foxmail.com', '1', '0', '', '2');
