...
) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=utf8 COMMENT='收藏表，只有歌单能被收藏';
...
-- Records of comment
-- ----------------------------
INSERT INTO `comment` VALUES ('1', '1', '放空', '12', 'Yuban', '0', '只要她还肯露面，只要她还肯唱歌，只要她开心，她怎样都行。', '3727');
...
-- ----------------------------
INSERT INTO `song_list` VALUES ('1', '2', 'ixenos', '聆', '0', '3634', '1,2,3,5,6', '/LiveInYouth/images/discoverSongList/songList/songList-1.jpg', '小梦大半');
